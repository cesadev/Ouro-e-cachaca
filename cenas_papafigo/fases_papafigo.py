fases_do_jogo = {
    "luta_1_mapa_2": {
        "script_inimigo": {
            1: [{"acao": "jogar_carta", "carta": {"nome": "Caboclo D’água", "vida": 1, "dano": 1, "selos":["mergulhador"]}, "slot": 0},
                {"acao": "jogar_carta", "carta": {"nome": "Caboclo D’água", "vida": 1, "dano": 1, "selos":["mergulhador"]}, "slot": 1},
                {"acao": "jogar_carta", "carta": {"nome": "Capelobo", "vida": 2, "dano": 1, "selos":[]}, "slot": 2}],
            2: [{"acao": "jogar_carta", "carta": {"nome": "Acauã", "vida": 3, "dano": 2, "selos":["voar"]}, "slot": 3}],
            3: [{"acao": "jogar_carta", "carta": {"nome": "Boitatá", "vida": 1, "dano": 2, "selos":[]}, "slot": 2}],
            4: [{"acao": "jogar_carta", "carta": {"nome": "Caboclo D’água", "vida": 1, "dano": 1, "selos":["mergulhador"]}, "slot": 2}],
            5: [{}],
            6: [{"acao": "jogar_carta", "carta": {"nome": "Acauã", "vida": 3, "dano": 2, "selos":["voar"]}, "slot": 3}]
        }
    },
    ...
    "luta_2_mapa_2": {
        "script_inimigo": {
            ...
            2: [{"acao": "jogar_carta", "carta": {"nome": "Boitatá", "vida": 1, "dano": 2, "selos":[]}, "slot": 1},
                {"acao": "jogar_carta", "carta": {"nome": "Cobra Coral", "vida": 2, "dano": 2, "selos":["mortal"]}, "slot": 2}],
            3: [{"acao": "jogar_carta", "carta": {"nome": "Curupira", "vida": 2, "dano": 3, "selos":[]}, "slot": 0}],
            4: [{"acao": "jogar_carta", "carta": {"nome": "Caboclo D’água", "vida": 1, "dano": 1, "selos":["mergulhador"]}, "slot": 3}],
            5: [{}],
            6: [{"acao": "jogar_carta", "carta": {"nome": "Mula Sem-Cabeça", "vida": 4, "dano": 3, "selos":[]}, "slot": 0}]
        }
    },
