...
class CenaMapa(CenaBase):
    def __init__(self, tela, nodo_atual=0):
        ...
        self.nos_clicaveis = [
            ...
            {"id": 1, "rect": pygame.Rect(239, 458, 80, 80), "destino": "comprar_cartas_caboclo", "proximos": [2,3]},
            ...
            {"id": 4, "rect": pygame.Rect(434, 167, 80, 80), "destino": "luta_1_mapa_1", "proximos": [8]},
            {"id": 5, "rect": pygame.Rect(435, 600, 80, 80), "destino": "luta_2_mapa_1", "proximos": [6,7]},
            ...
            {"id": 8, "rect": pygame.Rect(689, 174, 80, 80), "destino": "comprar_cartas_caboclo", "proximos": [11]},
            {"id": 9, "rect": pygame.Rect(784, 464, 80, 80), "destino": "comprar_cartas_caboclo", "proximos": [12]},
            ...
            {"id": 12, "rect": pygame.Rect(922, 462, 80, 80), "destino": "luta_3_mapa_1", "proximos": [13, 14]},
            {"id": 13, "rect": pygame.Rect(1002, 315, 80, 80), "destino": "comprar_cartas_caboclo", "proximos": [15]},
            ...
            {"id": 17, "rect": pygame.Rect(1320, 453, 80, 80), "destino": "boss_1", "proximos": []}]
